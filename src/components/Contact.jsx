...
const Contact = () => {
  ...
  const handleChange = (e) => {
    const { name, value } = e.target; // we went two steps deep, because the two variables exist in the E props

    setForm({ ...form, [name]: value })// spread the form and then update it with the params
  }
  ...
  const handleSubmit = (e) => {
    ...
    .then(() => {
      setLoading(false);
      alert('Gracias, I will get back to you as soon as possible.');
